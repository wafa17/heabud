              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-2"/>
                    <div id= "discount" class="text mt-8 text-decoration-line-through"> Rp 300.000</div>
              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <v-divider class="my-2"/>
                    <div id= "discount" class="text mt-7 text-decoration-line-through"> Rp 400.000</div>
