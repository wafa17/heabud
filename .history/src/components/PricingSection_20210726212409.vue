      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 id="mainfont" class="text-center pt-6 font-weight-bold">Packages</h1>
            <v-divider class="my-6"></v-divider>
            <v-row class="text-center" id="fontype">
              <v-col class="col-11 col-sm-5 col-md-3">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Beginner</div>
                    <v-divider class="my-2"/>
                    <div class="text">Free Access to All Online Classes</div>
                    <v-divider class="my-2"/>
                    <div class="text">Personal Couch</div>
                    <v-divider class="my-2"/>
                    <div class="text">Healthy Calculator</div>
                    <v-divider class="my-2"/>
                    <div class="text font-weight-bold text-h4 mt-6">Rp 120.000</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Intermediate</div>
                    <v-divider class="my-2"/>
                    <div class="text">Free Access to All Online Classes</div>
                    <v-divider class="my-2"/>
                    <div class="text">Personal Couch</div>
                    ...
                    <div class="text">Healthy Calculator</div>
                    <v-divider class="my-2"/>
                    <div id="pricetag" class="text font-weight-bold text-h4 mt-6">Rupiah 120.000</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Advanced</div>
                    <v-divider class="my-2"/>
                    <div class="text">Domínios personalizados</div>
                    <v-divider class="my-2"/>
                    <div class="text">Acessos ilimitados</div>
                    <v-divider class="my-2"/>
                    <div class="text">Outras características...</div>
                    <v-divider class="my-2"/>
              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Extra</div>
                    <v-divider class="my-2"/>
