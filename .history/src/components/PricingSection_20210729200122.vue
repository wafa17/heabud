              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                          <v-img src="~@/assets/img/beginner.png"></v-img>
                      </div>
                    </div>
                    ...
                    <v-divider class="my-2"/>
                    <div id="pricetag" class="text mt-6">Rp 250.000</div>
              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                          <v-img src="~@/assets/img/intermediate.png"></v-img>
                      </div>
                    </div>
                    ...
                    <v-divider class="my-2"/>
                    <div id="pricetag" class="text mt-6">Rp 350.000</div>
                    <div id= "caption" class="text mt-2 font-weight-light">*per month</div>
                    <v-btn
                        v-bind="size"
                        rounded
              ...
              <v-col class="col-11 col-sm-5 col-md-3">
                ...
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                          <v-img src="~@/assets/img/advanced.png"></v-img>
                      </div>
                    </div>
                    ...
                    <v-divider class="my-2"/>
                    <div id= "caption" class="text mt-1 font-weight-light text-decoration-line-through">950.00</div>
                    <div id="pricetag" class="text mt-6">Rp 800.000</div>
